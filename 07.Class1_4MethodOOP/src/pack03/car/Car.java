...
//	같은 패키지 내부에서는 같은 이름의 클래스(객체)가 존재할 수 없음.
	
//	인터넷 주소의(도메인) 반대로 사용하는 네이밍을 가지고 있음
//	com.naver.www <== 식별할 수 있게 패키지 이름을 지음
//				  <== 플레이 스토어 등록 시 같은 이름의 패키지가 먼저 있다면 등록 x
	Tire hankookTire1 = new Tire();
	Tire hankookTire2 = new Tire();
	pack02.kumho.Tire kumhoTire3 = new pack02.kumho.Tire();
	pack02.kumho.Tire kumhoTire4 = new pack02.kumho.Tire();
}
